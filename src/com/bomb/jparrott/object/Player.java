...
public class Player extends Character{
    ...
    public void update(int delta){
        ...
        if(!dead) {
            ...
            //calculate movement
            Direction direction;
            if (gameInput.isPressed(GameInput.Button.UP)) {
                direction = Direction.NORTH;
                move(direction, delta);
            } else if (gameInput.isPressed(GameInput.Button.DOWN)) {
                direction = Direction.SOUTH;
                move(direction, delta);
            } else if (gameInput.isPressed(GameInput.Button.LEFT)) {
                direction = Direction.WEST;
                move(direction, delta);
            } else if (gameInput.isPressed(GameInput.Button.RIGHT)) {
            ...
            if (gameInput.isPressed(GameInput.Button.B)) {
